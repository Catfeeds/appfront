...
<body>
    ...
    <div id="index1" style="overflow-x:auto;">
        <div style="width: 1160px;margin:0 auto;">
                            ...
                            <div class="el-step__head is-finish">
                                <div class="el-step__line" style="margin-right: 0px;">
                                    <i class="el-step__line-inner"
                                       style="transition-delay: 0ms; border-width: 0px; width: 0%;"></i>
                                </div>
            ...
            <h1 style="text-align: center; font-size: 20px; color: rgb(48, 163, 254); line-height: 50px; border-bottom: 1px solid rgb(238, 238, 238);">
                入驻须知</h1>
