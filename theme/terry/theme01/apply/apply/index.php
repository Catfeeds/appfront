   ...
   <div  class="settle">
    ...
    <div  class="settle-content">
     <div  class="content1">
      ...
      <div  class="content3">
       <div  class="name1">
        <span  style="color: rgb(81, 102, 118);">欢迎来到晋彤电商平台</span>
       </div> 
       <div  class="cp1">
        <p ><span  style="color: rgb(124, 132, 139);">若您还没有填写入驻申请资料，请点击 <a  href="<?= Yii::$service->url->getUrl('apply/apply/notes') ?>" class="router-link-exact-active router-link-active" style="color: rgb(51, 164, 254);">&quot;我要入驻&quot;</a>进行入驻资料填写</span></p>
       </div> 
       <div  class="cp1">
        <p ><span  style="color: rgb(124, 132, 139);">若您的店铺还未开通，请通过 <a  href="#/index" class="router-link-exact-active router-link-active" style="color: rgb(51, 164, 254);">&quot;查看入驻进度&quot;</a> 了解店铺开通的最新消息</span></p>
       </div> 
       <button  type="button" class="el-button el-button--primary el-button--small is-round">
        
        <span><a  href="<?= Yii::$service->url->getUrl('apply/apply/notes') ?>" class="" style="color: rgb(255, 255, 255);">我要入驻</a></span></button>
      </div>
     </div>
    </div> 
    <div  class="settle-p">
     <div  class="admin-tablename">
      ...
      <span  class="admin-tablename2">流程</span>
     </div> 
     <div  style="margin-left: 70px; height: 129px; margin-top: 20px;">
      <div  class="sp1">
       <img  src="/public/imgs/s1.png" alt="" /> 
       <span >签署入驻协议</span>
      </div> 
      <div  class="jiantou"></div> 
      <div  class="sp1">
       <img  src="/public/imgs/s2.png" alt="" /> 
       <span >商家信息提交</span>
      </div> 
      <div  class="jiantou"></div> 
      <div  class="sp1">
       <img  src="/public/imgs/s3.png" alt="" /> 
       <span >平台审核资质</span>
      </div> 
      <div  class="jiantou"></div> 
      <div  class="sp1">
       <img  src="/public/imgs/s4.png" alt="" /> 
       <span >店铺开张</span>
      </div>
     </div>
    </div> 
