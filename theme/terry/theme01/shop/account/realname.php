                ...
                <div class="biaoti">
                    <div aria-label="Breadcrumb" role="navigation" class="el-breadcrumb">
                        ...
                        <span class="el-breadcrumb__item" aria-current="page"><span role="link"
                                        ...
                                        style="color: rgb(48, 211, 102);">实名认证</span></span><span role="presentation"
                        ...
                        <form class="el-form">
                            <div class="el-row" style="width: 850px;">
                                <div class="el-form-item">
                                    ...
                                    <div class="el-form-item__content" style="margin-left: 150px;">
                                        <div class="el-input" style="width: 500px;">
                                            <input type="text" autocomplete="off" placeholder="王卓"
                                ...
                                <div class="el-form-item">
                                    ...
                                    <div class="el-form-item__content" style="margin-left: 150px;">
                                        <div class="el-input" style="width: 500px;">
                                            <input type="text" autocomplete="off" placeholder="342605121212121200"
                                                   class="el-input__inner"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="el-form-item">
                                    ...
                                    <div class="el-form-item__content" style="margin-left: 150px;">
                                        <div class="el-input" style="width: 500px;">
                                            <input type="text" autocomplete="off" placeholder="上海建设银行中山支行"
                                                   class="el-input__inner"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="el-form-item">
                                    ...
                                    <div class="el-form-item__content" style="margin-left: 150px;">
                                        <div class="el-input" style="width: 500px;">
                                            <input type="text" autocomplete="off" placeholder="123456789123456789"
                                                   class="el-input__inner"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="el-form-item">
                                    ...
                                    <div class="el-form-item__content" style="margin-left: 150px;">
                                        <div class="el-input" style="width: 500px;">
                                            <input type="text" autocomplete="off" placeholder="13112341234"
                                                   class="el-input__inner"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="el-form-item">
                                    <label class="el-form-item__label" style="width: 150px;">*手机号码</label>
                                    <div class="el-form-item__content" style="margin-left: 150px;">
                                        <div style="line-height: 28px;">已认证</div>
                                    </div>
                                </div>
                            </div>
                        </form>
