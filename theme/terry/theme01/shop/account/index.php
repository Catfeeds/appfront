        ...
        <div class="el-table__header-wrapper">
         <table cellspacing="0" cellpadding="0" border="0" class="el-table__header" style="width: 1064px;">
          <colgroup>
           ...
           <col name="el-table_2_column_12" width="105" />
           <col name="el-table_2_column_13" width="150" />
           <col name="el-table_2_column_14" width="150" />
           <col name="el-table_2_column_15" width="103" />
           <col name="el-table_2_column_16" width="150" />
           <col name="el-table_2_column_17" width="150" />
           <col name="el-table_2_column_18" width="103" />
           <col name="el-table_2_column_19" width="103" />
           <col name="gutter" width="0" />
          </colgroup>
          <thead class="has-gutter">
           <tr class="">
            <th colspan="1" rowspan="1" class="el-table_2_column_11   el-table-column--selection  is-leaf">
             <div class="cell">
