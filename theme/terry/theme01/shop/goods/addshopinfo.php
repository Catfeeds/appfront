    ...
    <div style="width: 1064px; margin: 0px auto;">
        <div class="biaoti">
            <div aria-label="Breadcrumb" role="navigation" class="el-breadcrumb">
                ...
                <span class="el-breadcrumb__item"><span role="link" class="el-breadcrumb__inner"><a href="#/goods"
                                                                                                    class="">商品列表</a></span><span
                            role="presentation" class="el-breadcrumb__separator">&middot;</span></span>
                <span class="el-breadcrumb__item" aria-current="page"><span role="link"
                                                                            class="el-breadcrumb__inner"><span
                                style="color: rgb(48, 211, 102); font-weight: bolder;">添加商品</span></span><span
                            role="presentation" class="el-breadcrumb__separator">&middot;</span></span>
            </div>
        </div>
        <div class="item">
            ...
            <div class="bottom">
                ...
                <div class="title">
                    ...
                    <div aria-label="Breadcrumb" role="navigation" class="el-breadcrumb" style="display: inline-block;">
                        <span class="el-breadcrumb__item"><span role="link"
                                                                class="el-breadcrumb__inner"><?= $one ?></span><span
                                    role="presentation" class="el-breadcrumb__separator">/</span></span>
                        <span class="el-breadcrumb__item" aria-current="page"><span role="link"
                                                                                    class="el-breadcrumb__inner"><?= $two ?></span><span
                                    role="presentation" class="el-breadcrumb__separator">/</span></span>
                    </div>
                    <div class="neirong">
                        <form class="el-form" method="post" enctype="multipart/form-data"
                            ...
                            <div class="el-form-item">
                                ...
                                <div class="el-form-item__content" style="margin-left: 80px;">
                                    <div class="inputbox el-input">
                                        <input type="text" name="sku" autocomplete="off" class="el-input__inner"/>
                                    </div>
                                    <div class="tishi">
                                        商家货号是指商家管理商品的编号，买家不可见，最多可输入20个字符，支持输入中文、英文、字母、_、/和小数点
                                    </div>
                                </div>
                            </div>
                            <div class="el-form-item">
                            ...
                            <div class="el-form-item">
                                <label class="el-form-item__label" style="width: 80px;">商品简单描述</label>
                                <div class="el-form-item__content" style="margin-left: 80px;">
                            ...
                            <div class="el-form-item">
                                ...
                                <div class="el-form-item__content" style="margin-left: 80px;">
                                    <div class="inputbox el-input">
                                        <input type="text" autocomplete="off" name="price" class="el-input__inner"/>
                                    </div>
                                    <div class="tishi">
                            ...
                            <div class="el-form-item">
                                ...
                                <div class="el-form-item__content" style="margin-left: 80px;">
                                    <div class="inputbox el-input">
                                        <input type="text" autocomplete="off" name="special_price"
                ...
                <div class="message">
                    ...
                    <div style="width: 100%; margin-left: 70px; margin-top: 15px;">
                        <a href="#/GoodsAdd2" class="router-link-exact-active router-link-active"></a>
