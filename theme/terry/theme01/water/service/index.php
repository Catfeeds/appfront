            ...
            <div class="content">
                <div class="biaoti">
                    <div aria-label="Breadcrumb" role="navigation" class="el-breadcrumb">
                        <span class="el-breadcrumb__item">
                            <span role="link" class="el-breadcrumb__inner is-link">服务管理</span>
                            <span role="presentation" class="el-breadcrumb__separator">&middot;</span>
                        </span>
                        <span class="el-breadcrumb__item" aria-current="page">
                            <span role="link" class="el-breadcrumb__inner">
                                <span style="color: rgb(48, 211, 102); font-weight: bolder;">服务列表</span>
                            </span>
                            <span role="presentation" class="el-breadcrumb__separator">&middot;</span>
                        </span>
                    </div>
                ...
                <form action="<?php echo  Yii::$app->request->getHostInfo().Yii::$app->request->url;?>" method="get">
                    <ul class="shuaixuan">
                        ...
                        <li><a href="<?= Yii::$service->url->getUrl('water/service/addclass') ?>" class="">
                                ...
                                <div class="el-tabs__nav-scroll">
                                    <div role="tablist" class="el-tabs__nav is-top" style="transform: translateX(0px);">
                                        ...
                                        <div style="padding-left:20px;"  class="el-tabs__item is-top <?php echo $_GET['status']==0 ?'is_active1':'';?>">
                                            <a style="" href="<?php echo  Yii::$app->request->getHostInfo().'/'.Yii::$app->request->pathInfo;?>?class=<?=$_GET['class']?>&status=0">全部服务（<?=$tot?>）</a>
                                        </div>
                                            ...
                                            <?php foreach ($goods as $v) { ?>
                                                <tr class="el-table__row">
                                                        ...
                                                        <div class="cell el-tooltip">
                                                            ...
                                                            <div class="contents">
                                                                ...
                                                                <div title="<?=  $v["name"]["name_zh"] ?>" class="ddd" >
                                                                    <span style="color: rgb(186, 190, 193);">服务名：</span><?= $v["name"]["name_zh"] ?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="el-table_2_column_12">
                                                        <div class="cell el-tooltip">
                                                            <div role="switch" aria-checked="true"
                                                                ...
                                                                <a href="<?= Yii::$service->url->getUrl('water/service/status', array('id' => $v['_id'], 'status' => $v['status'])) ?>">
                                                    ...
                                                    <td class="el-table_2_column_14">
                                                        <div class="cell el-tooltip">
                                                            <a href="<?= Yii::$service->url->getUrl('water/service/find', array('id' => $v['_id'])) ?>"
                                                               class="">
                                                                <button type="button"
                                                            ...
                                                            <a href="<?= Yii::$service->url->getUrl('water/service/del', array('id' => $v['_id'])) ?>">
                                                                <button type="button"
                                                                        class="el-button el-button--text el-button--small">
