    ...
    <div style="width: 1012px; margin: 0px auto;">
        <div class="biaoti">
            <div aria-label="Breadcrumb" role="navigation" class="el-breadcrumb">
                <span class="el-breadcrumb__item"> <span role="link" class="el-breadcrumb__inner is-link">维修服务</span> <span role="presentation" class="el-breadcrumb__separator">&middot;</span></span>
                <span class="el-breadcrumb__item"><span role="link" class="el-breadcrumb__inner"><a href="#/goods" class="">服务列表</a></span><span role="presentation" class="el-breadcrumb__separator">&middot;</span></span>
                <span class="el-breadcrumb__item" aria-current="page"><span role="link" class="el-breadcrumb__inner"><span style="color: rgb(48, 211, 102); font-weight: bolder;">添加服务</span></span><span role="presentation" class="el-breadcrumb__separator">&middot;</span></span>
            </div>
        </div>
        <div class="item">
            <ul class="top">
            ...
            <div class="bottom">
                <div class="title">
                    <span style="font-size: 14px; color: rgb(206, 203, 203);">您当前选择的服务类别是：</span>
...
<script>
    ...
    function next() {
        ...
        if ($("#one").val() && $("#two").val()) {
            ...
            location.href = "<?= Yii::$service->url->getUrl('water/service/addshopinfo') ?>" + "?one=" + $("#one").val() + "&tow=" + $("#two").val();
        } else {
            alert("请选择分类");
        }
    }
