            ...
            <div class="content">
                <div class="biaoti">
                    <div aria-label="Breadcrumb" role="navigation" class="el-breadcrumb">
                        <span class="el-breadcrumb__item"><span role="link"
                                                                class="el-breadcrumb__inner is-link">账号管理</span><span
                        ...
                        <span class="el-breadcrumb__item" aria-current="page"><span role="link"
                                        ...
                                        style="color: rgb(48, 211, 102);">资金列表</span></span><span role="presentation"
                ...
                <div class="item">
                            ...
                            <table cellspacing="0" cellpadding="0" border="0" class="el-table__header"
                                ...
                                <tr style="font-size: 14px;color: #B1DBFE;">
                                    <th colspan="1" rowspan="1"
                                        class="el-table_2_column_10   el-table-column--selection  is-leaf">
                                        <div class="cell">
                    ...
                    <div style="position: relative;">
                        <div style="width: 180px; position: absolute; right: 0px; top: 0px; display: flex; justify-content: space-between;">
